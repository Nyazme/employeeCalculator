package com.mark.employeeCalculator.controller;

import com.mark.employeeCalculator.data.EmployeeRepository;
...
public class BaseController {
    ...
    public @ResponseBody
    List<Employee> findEmployeeById(@PathVariable String id) {
    ...
    public @ResponseBody
    Employee postEmployee(@RequestBody Map<String, Object> payload) {
