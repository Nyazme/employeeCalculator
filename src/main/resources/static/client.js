...
function postEmployee(event) {
            ...
            //Get the info on the DOM and store it as Vars
            var idText = $("#id").val();
            ...
            $("#twiceAMonthlySalary").text("Twice a Month Salary Spend for the Company: $" + total/24);


            //Use those vars to create our object that will go to the server
            var newEmployee = {
                id: idText,
                firstName: fNameText,
                lastName: lNameText,
